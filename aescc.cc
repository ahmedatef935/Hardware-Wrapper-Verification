...
extern "C"   char* encrypt1(char* msg ,unsigned char* key)
{
...
unsigned  char x;
  ...
  //}
    cout << "C++:ciphertext: " << output1 << "\n";
  for (int u = 0; u < 16; u++) {

		if (output1[u * 2] == '0' && output1[u * 2 + 1] == '0') {
			 output1.erase(u * 2, 2);
	...
	delete[] padded_msg;
	return  (char*)output1.c_str();
}



///////////////////////////////////////////////
extern "C" char* gethex(char* padded_msg ){
